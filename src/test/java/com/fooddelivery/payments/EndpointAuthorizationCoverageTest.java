 ...
 * Mentioning PaymentController for validation.
 *
...
class EndpointAuthorizationCoverageTest {
     ...
     *
     * <p>Payment gateways call these directly and cannot present a platform principal. CommonSecurityConfig permitAlls /api/v1/webhooks/** on the basis that each is verified by gateway signature.
     */
    private static final Set<String> INTENTIONALLY_ANONYMOUS = Set.of(
            "WebhookController#handleCashfreeWebhook",
            "WebhookController#handleRazorpayWebhook",
            "WebhookController#handleVyaparWebhook");
